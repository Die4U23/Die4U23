...
<p>
  <img src="https://skillicons.dev/icons?i=cpp,python,linux,git,js,docker,redis,pytorch,fastapi&perline=9" alt="C++、Python、Linux、Git、JavaScript、Docker、Redis、PyTorch 和 FastAPI" />
</p>
